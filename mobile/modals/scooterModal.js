...
import {
    ...
    TouchableOpacity}
from 'react-native'
import scooters from '../src/scooterInfo.json';
...
export default class ScooterModal extends React.Component {
    ...
    show = (number, addres) => {    
        ...
        this.state.data = scooters.filter(element => element.station == number);
        ...
        return(           
            <View style={styles.itemContainer}>
                <View style={styles.row}>                       
                    <Image style={styles.bicyclePicture} source={require('../src/img/scooter_modal.png')} />
                    <View style={[styles.column, {marginLeft: 20}]}>
                        <Text style={styles.modelText}>{item.model}</Text>
                        <View style={[styles.row, {marginTop: 15}]}>
                            <Text style={styles.rateText}>100 грн/час</Text>
...
const styles = StyleSheet.create ({
    ...
    modal: {
        ...
        width: "100%",
        height: 100 + scootersAmount*(itemHeight + 15),
        alignItems: 'center',
